...
void save_sup_page(struct sup_page_entry *sup_page,void *address, uint32_t r_bytes, uint32_t z_bytes,uint32_t file_p,bool wr, int tp, struct file *file,void **esp, void (**eip) (void), char **save_ptr,void *ptr )
{
